...
from backend.face_recognition.utils.data_augmentation import augment
...
def align_embed(frame, start_x, start_y, end_x, end_y):
    ...
    #align image
    detected_face_numpy = face_alignment.align(cropped_img, start_x, start_y, end_x, end_y)#.transpose(2,1,0)
